...
tnpModelsNom.GetData(01).UpdateParams({"BPacms":(10,),"BPbeta":(1,),"BFacms":(10,),"BFbeta":(1,),"SFsigmaRatio":(1,),
                                       "SFmean2":(90,88,91),"SFmean1":(90,88,91),"SFsigma1":(3,1,5),"SPwidth":(3,)}) 
tnpModelsNom.GetData(02).UpdateParams({"BFacms":(10,),"BFbeta":(1,),})
tnpModelsNom.GetData(03).UpdateParams({"SFsigmaRatio":(1,1,2),"SFmean2":(90,88,92),"SFmean1":(90,88,92)})
