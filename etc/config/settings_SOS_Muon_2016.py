...
tnpModelsNom.GetData(02).UpdateParams({"SFmean1":(90,86,92),"SFmean2":(90,86,92)})
tnpModelsNom.GetData(03).UpdateParams({"BFacms":(10,),"BFbeta":(1,), "SPsigma":(1.,0.5,5.0), "SPwidth":(1.,),})
tnpModelsNom.GetData(04).UpdateParams({"SFmean1":(90,86,92),"SFmean2":(90,86,92)})
tnpModelsNom.GetData(05).UpdateParams({"SFmean1":(90,86,92),"SFmean2":(90,86,92)})
