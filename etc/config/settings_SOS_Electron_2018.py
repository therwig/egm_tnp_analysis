...
tnpModelsNom.GetData(00).UpdateParams({"BFacms":(10,),"BFbeta":(1,),"SFmean2":(90,88,91),"SFmean1":(90,88,91)})
# tnpModelsNom.GetData(01).SetFitRange(70,110) # this fit is very poor
tnpModelsNom.GetData(01).UpdateParams({"BFacms":(10,),"BFbeta":(1,),"SFsigmaRatio":(1,),
                                        "SFmean2":(91),"SFmean1":(91),"SFsigma1":(1.6)}) 
tnpModelsNom.GetData(02).UpdateParams({"BFacms":(10,),"BFbeta":(1,),})
tnpModelsNom.GetData(03).UpdateParams({"BFacms":(10,),"BFbeta":(1,),"SFsigmaRatio":(1,1,2),"SFmean2":(90,88,92),"SFmean1":(90,88,92)})
tnpModelsNom.GetData(04).UpdateParams({"BFacms":(80,), "BFbeta":(0.02,), "BFgamma":(0.059,),"SFsigmaRatio":(1,),"SFmean2":(90,88,92)})
tnpModelsNom.GetData(06).UpdateParams({"SFmean2":(90,86,92),"SFmean1":(90,86,92),"SFsigmaRatio":(1,0.5,5)})
tnpModelsNom.GetData(07).UpdateParams({"SFmean2":(90,86,92),"SFmean1":(90,86,92),"SFsigmaRatio":(1,0.5,5)})

# Alternate Signal -- Data
tnpModelsAltSig.GetData(00).UpdateParams({"BFacms":(10,),"BFbeta":(1,),}) 
tnpModelsAltSig.GetData(01).SetFitRange(70,110) # this fit is very poor
tnpModelsAltSig.GetData(01).UpdateParams({"BFacms":(10,),"BFbeta":(1,),"BPacms":(10,),"BPbeta":(1,),
                                          "SFmean2":(90,88,91),"SFmean1":(90,88,91),"SFsigma1":(1,0.5,3),"SFsigma2":(1,0.5,3)}) 
tnpModelsAltSig.GetData(02).UpdateParams({"BFacms":(10,),"BFbeta":(1,),})
tnpModelsAltSig.GetData(03).UpdateParams({"BFacms":(10,),"BFbeta":(1,),})
...
tnpModelsAltBkg.UpdateDataModel(4, DoubleVoigt(), BernsteinN(4))
tnpModelsAltBkg.GetData(4).UpdateParams({"SFmean1":(88,86,92),"SFmean2":(88,86,92)})
tnpModelsAltBkg.UpdateDataModel(5, DoubleVoigt(), BernsteinN(4))
tnpModelsAltBkg.GetData(5).UpdateParams({"SFmean1":(88,86,92),"SFmean2":(88,86,92)})
tnpModelsAltBkg.UpdateDataModel(6, DoubleVoigt(), BernsteinN(5))
tnpModelsAltBkg.GetData(06).UpdateParams({"SFmean1":(90,88,92),"SFmean2":(90,88,92),"SPmean1":(90,88,92),"SPmean2":(90,88,92)})
