...
baseOutDir = "results/SOS_Electron_2018/"


#############################################################
########## samples definition  - preparing the samples
#############################################################
import etc.inputs.tnpSampleDef_SOS_Electron_2018 as tnpSamples
tnpTreeDir = "./Events"

samplesDef = {
    "data"   : tnpSamples.SOS_Electron_2018["data"].clone(),
    "mcNom"  : tnpSamples.SOS_Electron_2018["DY"].clone(),
    "mcAlt"  : tnpSamples.SOS_Electron_2018["DY"].clone(),
    "tagSel" : tnpSamples.SOS_Electron_2018["DY"].clone(),
}
...
#############################################################
cutBase   = "Tag_pt > 34 && abs(Tag_eta) < 2.5 && Tag_cutBased > 3 && Tag_isGenMatched && Probe_pt > 5.0 && abs(Probe_eta) < 2.5 && Probe_isGenMatched && TnP_trigger && Probe_charge*Tag_charge < 0" # tightNoIsoObject
#cutBase   = "Tag_pt > 34 && abs(Tag_eta) < 2.5 && Tag_cutBased > 3 && Tag_isGenMatched && Probe_pt > 5.0 && abs(Probe_eta) < 2.5 && Probe_isGenMatched && TnP_trigger && Probe_charge*Tag_charge < 0 && " + Probe_isTightNoIso # tightObjectOverTightNoIso
...
tnpParDoublePeakNomFit = [
    ...
    #"meanF1[95,90,100]", "width[3.0]", "sigmaF1[3.0,2.5,3.5]", "meanF2[75,70,80]", "sigmaFRatio[9,6.5,10]",
    # bin01
    ...
    # bin19
    #"meanP1[90,80,100]", "width[3.0]", "sigmaP1[2.2]", "meanP2[90,20,100]", "sigmaPRatio[4,1.5,10]",
    #"meanF1[90,80,100]", "width[3.0]", "sigmaF1[1.0,0.5,2.5]", "meanF2[90,20,100]", "sigmaFRatio[4,1.5,10]",
    ...
    #"acmsF[47.0]","betaF[0.80]","gammaF[0.012]","peakF[90.0]",
    # bin02
    #"meanP1[90,88,92]", "width[2.0]", "sigmaP1[1.7,1.5,3.5]", "meanP2[70,60,80]", "sigmaPRatio[5,1.0,20.0]",
    ...
    #"acmsF[50.]","betaF[0.01]","gammaF[0.036]","peakF[90.0]",
    # bin04
    ...
    #"acmsF[50.]","betaF[0.01]","gammaF[0.043]","peakF[90.0]",
    # bin05
    #"meanP1[90,80,100]", "width[3.0]", "sigmaP1[1.0,0.5,4.5]", "meanP2[65,60,70]", "sigmaPRatio[4,1.5,10]",
    #"meanF1[90,80,100]", "width[3.0]", "sigmaF1[1.0,0.5,4.5]", "meanF2[65,50,70]", "sigmaFRatio[1,0.5,1.5]",
    # bin06
    ...
    ####################### MC #####################
    ### bin00
    ###"meanP1[90,80,100]", "width[2.5,1.5,3.0]", "sigmaP1[1.0,0.5,2.5]", "meanP2[90,60,70]", "sigmaPRatio[4,1.5,10]",
    ###"meanF1[90,80,100]", "width[2.5,1.5,3.0]", "sigmaF1[1.0,0.5,2.5]", "meanF2[90,20,100]", "sigmaFRatio[4,1.5,10]",
    ### bin01
    ...
    ###"meanF1[90,80,100]", "width[2.5,2.0,3.0]", "sigmaF1[1.0,0.5,2.5]", "meanF2[90,20,100]", "sigmaFRatio[4,1.5,10]",
    ### bin05
    ###"meanP1[90,80,100]", "width[2.5,2.0,3.0]", "sigmaP1[1.0,0.5,3.2]", "meanP2[90,20,100]", "sigmaPRatio[4,1.5,10]",
    ###"meanF1[90,80,100]", "width[2.5,2.0,3.0]", "sigmaF1[1.0,0.5,3.5]", "meanF2[90,50,100]", "sigmaFRatio[4,1.5,10]",
    ### bin06
    ###"meanP1[90,80,100]", "width[2.5,2.0,3.0]", "sigmaP1[1.0,0.5,2.3]", "meanP2[90,20,100]", "sigmaPRatio[4,1.5,10]",
    ...
    ###"meanF1[90,80,100]", "width[2.5,2.0,3.0]", "sigmaF1[1.0,0.5,1.8]", "meanF2[90,20,100]", "sigmaFRatio[4,1.5,10]",
    ### bin15
    ###"meanP1[90,80,100]", "width[3.0]", "sigmaP1[1.0,0.5,2.4]", "meanP2[90,20,110]", "sigmaPRatio[4,1.5,10]",
    ###"meanF1[90,80,100]", "width[3.0]", "sigmaF1[1.0,0.5,2.4]", "meanF2[90,20,110]", "sigmaFRatio[4,1.5,10]",
    ### bin16
    ###"meanP1[90,80,100]", "width[2.5,2.0,3.0]", "sigmaP1[1.0,0.5,1.2]", "meanP2[90,20,100]", "sigmaPRatio[4,1.5,10]",
    ###"meanF1[90,80,100]", "width[2.5,2.0,3.0]", "sigmaF1[1.0,0.5,2.2]", "meanF2[90,20,100]", "sigmaFRatio[4,1.5,10]",
    ### bin17
    ###"meanP1[90,80,100]", "width[2.5,2.0,3.0]", "sigmaP1[1.0,0.5,2.3]", "meanP2[90,20,100]", "sigmaPRatio[4,1.5,10]",
    ###"meanF1[90,80,100]", "width[2.5,2.0,3.0]", "sigmaF1[1.0,0.5,2.4]", "meanF2[90,20,100]", "sigmaFRatio[4,1.5,10]",
    ### bin18
    ###"meanP1[90,80,100]", "width[2.5,2.0,3.0]", "sigmaP1[1.0,0.5,1.2]", "meanP2[90,20,100]", "sigmaPRatio[4,1.5,10]",
    ###"meanF1[90,80,100]", "width[2.5,2.0,3.0]", "sigmaF1[1.0,0.5,2.5]", "meanF2[90,20,100]", "sigmaFRatio[4,1.5,10]",
    ### bin19
...
tnpParDoublePeakAltSigFit = [
    ...
    # bin00
    #"meanP1[90,80,100]","sigmaP1[0.9,0.5,2.7]","meanP2[75,70,85]","sigmaP2[0.9,0.5,19.0]",
    #"meanF1[90,80,100]","sigmaF1[0.9,0.5,5.0]","meanF2[90,20,110]","sigmaF2[0.9,0.5,5.0]",
    # bin01
    #"meanP1[90,88,92]","sigmaP1[0.9,0.5,5.0]","meanP2[75,70,85]","sigmaP2[0.9,0.5,7.0]",
    #"meanF1[90,85,92]","sigmaF1[0.9,0.5,5.0]","meanF2[75,60,80]","sigmaF2[3.9,2.5,7.0]",
    #"acmsP[65.]","betaP[0.01]","gammaP[0.040]","peakP[90.0]",
    #"acmsF[47.0]","betaF[0.80]","gammaF[0.012]","peakF[90.0]",
    # bin03
    #"meanP1[90,80,100]","sigmaP1[0.9,0.5,5.0]","meanP2[70,70,75]","sigmaP2[0.9,0.5,5.0]",
    #"meanF1[90,80,100]","sigmaF1[0.9,0.5,5.0]","meanF2[65,55,80]","sigmaF2[0.9,0.5,5.0]",
    # bin06
    #"meanP1[90,80,100]","sigmaP1[0.9,0.5,3.0]","meanP2[65,60,75]","sigmaP2[0.9,0.5,9.0]",
    #"meanF1[90,80,100]","sigmaF1[0.9,0.5,3.3]","meanF2[65,60,75]","sigmaF2[0.9,0.5,15.0]",
    #"acmsF[75.]","betaF[0.01]","gammaF[0.024]","peakF[90.0]",
    # bin07
...
tnpParDoublePeakAltBkgFit = [
    ...
    # bin00
    #"meanP1[90,80,100]", "width[2.0]", "sigmaP1[1.0,0.5,2.5]", "meanP2[60,55,75]", "sigmaPRatio[8,5.5,10]",
    #"meanF1[90,88,92]", "width[2.0]", "sigmaF1[1.5,1.0,2.0]", "meanF2[90,85,95]", "sigmaFRatio[2,1.0,9.0]",
    #"alphaF[-0.040]",
    # bin01
    #"meanP1[90,80,100]", "width[3.0]", "sigmaP1[1.0,0.5,4.5]", "meanP2[75,70,80]", "sigmaPRatio[4,1.5,10]",
    #"meanF1[90,88,92]", "width[3.0]", "sigmaF1[1.0,0.5,4.3]", "meanF2[90,20,100]", "sigmaFRatio[4,0.5,10]",
    ...
    # bin09
    #"meanP1[90,80,100]", "width[3.0]", "sigmaP1[1.0,0.5,2.0]", "meanP2[90,20,100]", "sigmaPRatio[4,1.5,10]",
    #"meanF1[90,80,100]", "width[3.0]", "sigmaF1[1.0,0.5,2.5]", "meanF2[90,80,100]", "sigmaFRatio[4,1.5,10]",
    # bin16
    #"meanP1[90,80,100]", "width[3.0]", "sigmaP1[1.3]", "meanP2[90,20,100]", "sigmaPRatio[4,1.5,10]",
    #"meanF1[90,80,100]", "width[3.0]", "sigmaF1[1.0,0.5,2.5]", "meanF2[90,20,100]", "sigmaFRatio[4,1.5,10]",
    # bin18
