...
baseOutDir = "results/SOS_Muon_2017/"


#############################################################
########## samples definition  - preparing the samples
#############################################################
import etc.inputs.tnpSampleDef_SOS_Muon_2017 as tnpSamples
tnpTreeDir = "./Events"

samplesDef = {
    "data"   : tnpSamples.SOS_Muon_2017["data"].clone(),
    "mcNom"  : tnpSamples.SOS_Muon_2017["DY"].clone(),
    "mcAlt"  : tnpSamples.SOS_Muon_2017["DY"].clone(),
    "tagSel" : tnpSamples.SOS_Muon_2017["DY"].clone(),
}
